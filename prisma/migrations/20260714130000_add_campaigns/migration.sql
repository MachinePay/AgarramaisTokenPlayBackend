...
CREATE TABLE "campaign_package_overrides" (
    "id" TEXT NOT NULL,
...
CREATE TABLE "campaign_machine_overrides" (
    "id" TEXT NOT NULL,
    "campaign_id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "campaign_package_overrides_campaign_id_package_id_key" ON "campaign_package_overrides"("campaign_id", "package_id");
CREATE INDEX "campaign_package_overrides_package_id_idx" ON "campaign_package_overrides"("package_id");
CREATE UNIQUE INDEX "campaign_machine_overrides_campaign_id_machine_id_key" ON "campaign_machine_overrides"("campaign_id", "machine_id");
CREATE INDEX "campaign_machine_overrides_machine_id_idx" ON "campaign_machine_overrides"("machine_id");
